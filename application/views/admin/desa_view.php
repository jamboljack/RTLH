...
<div id="adddata" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog"> 
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('admin/desa/savedata'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row"> 
                    <div class="col-md-12"> 
                        <div class="form-group"> 
                            ...
                            <select class="form-control" name="lstKecamatan" required>
                                <option value="">- Pilih Kecamatan -</option>
                                <?php foreach($listKecamatan as $c) { ?>
                                <option value="<?php echo $c->kecamatan_id; ?>"><?php echo $c->kecamatan_nama; ?></option>
                                <?php } ?>
                            </select>
                        </div> 
                    </div> 
                ...
                <div class="row"> 
                    <div class="col-md-12"> 
                        <div class="form-group"> 
                            ...
                            <input type="text" class="form-control" placeholder="Input Desa / Kelurahan" name="nama" autocomplete="off" required> 
                        </div> 
                    </div> 
                </div>
...
<div id="editdata" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog"> 
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('admin/desa/updatedata'); ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            ...
            <div class="modal-body">
                ...
                <div class="row"> 
                    <div class="col-md-12"> 
                        <div class="form-group"> 
                            <label class="control-label">Kecamatan</label> 
                            <select class="form-control kecamatan" name="lstKecamatan" required>
                                <option value="">- Pilih Kecamatan -</option>
                                <?php foreach($listKecamatan as $c) { ?>
                                <option value="<?php echo $c->kecamatan_id; ?>"><?php echo $c->kecamatan_nama; ?></option>
                                <?php } ?>
                ...
                <div class="row"> 
                    <div class="col-md-12"> 
                        <div class="form-group"> 
                            <label class="control-label">Desa / Kelurahan</label> 
                            <input type="text" class="form-control nama" placeholder="Input Desa / Kelurahan" name="nama" autocomplete="off" required> 
                        </div> 
                    </div> 
                </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box table-responsive">                    
                    <h4 class="m-t-0 header-title"><b>Desa / Kelurahan List</b></h4>
                    <br>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $r->desa_nama; ?></td>
                                <td>
                                    <button type="button" class="btn btn-warning btn-custom waves-effect waves-light btn-xs edit_button" data-toggle="modal" data-target="#editdata" data-id="<?php echo $r->desa_id; ?>" data-provinsi="<?php echo $r->provinsi_id; ?>" data-kabupaten="<?php echo $r->kabupaten_id; ?>" data-kecamatan="<?php echo $r->kecamatan_id; ?>" data-nama="<?php echo $r->desa_nama; ?>" title="Edit Data"><i class="icon-pencil"></i> Edit
                                    </button>
                                </td>
                            </tr>
                            <?php
